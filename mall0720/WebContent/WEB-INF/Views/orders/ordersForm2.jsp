...
<script>
  ...
  //orderInfo의 value에 따라 본인 정보 불러오기
...
<form action="/OrderItemController" method="post" id="ordersForm">
<div class="row">
	<div class="col-sm-6" >	
		<div id="div1">
		<h1>주문form</h1>
			...
			주문 정보가 본인 정보와 동일합니까? 
			<div>
				<input type="radio" id="orderInfo" value="same"/> 본인 정보와 동일
				<input type="radio" id="orderInfo" value="notSame"/> 새로운 주문 정보
			</div>
			<br/>
			<h2>주문자 정보</h2>
			<div>
			...
			<div>
				...
				<input type="text" name="recipientPhone" class="form-control"  value="- 없이 번호만 입력하세요"/>
			</div>
			<br/>
		</div>
	</div>
	<div class="col-sm-6" >
		<div id="div2">	
			...
			<div>
				...
				<input type="text" id="sample4_postcode" name="recipientPost" class="form-control"  readonly="readonly" placeholder="우편번호">
			</div>
			<div>
				<label for="recipientAddr">도로명 주소</label>
				<input type="text" id="sample4_roadAddress" name="recipientRoadAddr" class="form-control" readonly="readonly" placeholder="도로명주소">
			</div>
			<div>
				<label for="recipientDetail">지번 주소</label>
				<input type="text" id="sample4_jibunAddress" name="recipientParcelAddr" class="form-control" readonly="readonly" placeholder="지번주소">
			...
			<div>
				<lable for="paymentMethod">결제방식 :</lable>
